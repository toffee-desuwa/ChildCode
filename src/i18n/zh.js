...
export default {
  ...
  'config.provider': '图片生成服务',
  'config.providerHint': '国内用户可选择"OpenAI 兼容 API"并填写可用的 API 地址',
  'config.apiBase': 'API 地址',
  'config.apiBasePlaceholder': '例如：https://api.siliconflow.cn',
  'config.apiBaseHint': '填写兼容 OpenAI 接口的 API 基础地址',
  'config.usageLimit': '创作次数上限',
  'config.usageLimitPlaceholder': '例如：20',
  'config.ageTier': '孩子年龄段',
  'config.ageTierHint': '年龄段决定可用积木种类：基础 4 类 → 扩展 +情绪/天气 → 进阶 +时间',
  'config.save': '保存设置',
  'config.back': '返回首页',
  'config.saveSuccess': '保存成功（年龄段变更需刷新创作页生效）',
  'config.usageCount': '已使用：{count} 次',
  'config.usageCountWithLimit': '已使用：{count} / {limit} 次',
  'config.resetUsage': '重置已使用次数',

  // Parent Dashboard
  'dashboard.title': '孩子的成长面板',
  'dashboard.totalCreations': '总创作数',
  'dashboard.recentCreations': '近7天创作',
  'dashboard.comparisons': '对比次数',
  'dashboard.precision': '精准对比率',
  'dashboard.mastery': '掌握度',
  'dashboard.masteryLevel': '当前等级：{level}（{count} 次单块精准对比）',
  'dashboard.masteryHint': '精准对比 = 只改一个积木就生成对比，说明孩子在有意识地观察因果关系',
  'dashboard.masteryLevels.0': '小探索者',
  'dashboard.masteryLevels.1': '表达学徒',
  'dashboard.masteryLevels.2': '积木达人',
  'dashboard.masteryLevels.3': '控制大师',
  'dashboard.blockExploration': '积木探索广度',
  'dashboard.blockUsed': '用过 {count} 种',
  'dashboard.noHistory': '还没有创作记录',
  'dashboard.assets': '创作资产',
  'dashboard.assetsDetail': '模板：{templates} 个 | 故事板帧：{frames} 帧',
